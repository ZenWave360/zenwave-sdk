...
public class TestOrderFulfillmentAggregatesProject {
    private String basePackage = "io.zenwave360.example.orderfulfillment";

    @ParameterizedTest
    @ValueSource(strings = {"java", "kotlin"})
    public void testOrderFulfillmentAggregates(String targetLanguage) throws Exception {
        String sourceFolder = "src/test/resources/projects/order-fulfillment-aggregates";
        String targetFolder = "target/projects/order-fulfillment-aggregates-" + targetLanguage;
        String zdlFile = targetFolder + "/order-fulfillment-aggregates.zdl";
