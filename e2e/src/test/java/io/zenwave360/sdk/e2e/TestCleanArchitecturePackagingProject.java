...
public class TestCleanArchitecturePackagingProject {
    private String basePackage = "io.zenwave360.example.customer";

    @Test
    public void testCustomerAddressCleanArchitecturePackaging() throws Exception {
        String sourceFolder = "src/test/resources/projects/clean-architecture-project/";
        String targetFolder = "target/projects/layouts/clean-architecture-project";
