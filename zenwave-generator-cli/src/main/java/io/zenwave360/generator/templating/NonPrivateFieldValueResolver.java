...
/**
 * Fixes {@link com.github.jknack.handlebars.context.FieldValueResolver} disabling 'setAccessible' on private fields.
 *
 ...
 * @since 0.1.1
 */
public class NonPrivateFieldValueResolver extends MemberValueResolver<NonPrivateFieldValueResolver.FieldWrapper> {
   ...
   * @since 0.12.0
   */
  private static class FieldMember implements FieldWrapper {
   ...
   */
  public static final ValueResolver INSTANCE = new NonPrivateFieldValueResolver();
