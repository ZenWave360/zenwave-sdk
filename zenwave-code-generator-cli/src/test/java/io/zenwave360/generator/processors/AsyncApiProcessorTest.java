...
public class AsyncApiProcessorTest {
    ...
    public void testProcessAsyncApiTraits() throws Exception {
        Map<String, ?> model = loadAsyncapiModelFromResource("io/zenwave360/generator/parsers/asyncapi-shoping-cart.yml");
    ...
    public void testCalculateMessagesParamTypeForAsyncAPISchema() throws Exception {
        Map<String, ?> model = loadAsyncapiModelFromResource("io/zenwave360/generator/parsers/asyncapi-javaType.yml");
