...
public final class CustomFormatter {
  ...
  public CustomFormatter(JavaFormatterOptions options) {
  ...
  static void format(final JavaInput javaInput, JavaOutput javaOutput, JavaFormatterOptions options)
    ...
    Iterable<Diagnostic<? extends JavaFileObject>> errorDiagnostics =
        Iterables.filter(diagnostics.getDiagnostics(), CustomFormatter::errorDiagnostic);
    ...
    doc.computeBreaks(
        javaOutput.getCommentsHelper(), /* options.maxLineLength() */ 150, new Doc.State(+0, 0));
