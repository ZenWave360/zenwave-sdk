...
public class SpringKafkaTemplates extends AbstractAsyncapiGenerator.Templates {

    public SpringKafkaTemplates(AsyncAPIGenerator generator) {
        ...
        if(generator.transactionalOutbox == AsyncAPIGenerator.TransactionalOutboxType.none) {
            addTemplate(producerByServiceTemplates, "kafka/producer/outbox/none/Producer.java", "src/main/java/{{asPackageFolder producerApiPackage}}/{{producerClassName serviceName operationRoleType}}.java");
        } else {
