...
```xml
<configOption>
    <runtimeHeadersProperty>x-custom-runtime-expression</runtimeHeadersProperty>
</configOption>
```
...
ZenWave SDK generates an in-memory producer implementation for testing, allowing you to capture messages sent during a test without a real broker.

```java
// autogenerated in: target/generated-sources/zenwave/src/test/java/.../InMemoryCustomerOrderEventsProducer.java
