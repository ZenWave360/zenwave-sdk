...
public class EventCatalogEntitiesGenerator extends AbstractZDLGenerator {
    ...
    private final TemplateInput modelGlossaryTemplate = new TemplateInput("io/zenwave360/sdk/plugins/EventCatalogEntitiesGenerator/EventCatalogEntitiesGenerator.md", "{{targetFile}}").withMimeType(OutputFormatType.MARKDOWN);
    private final TemplateInput modelTaskListTemplate = new TemplateInput("io/zenwave360/sdk/plugins/EventCatalogEntitiesGenerator/ZdlToMarkdownTaskList.md", "{{targetFile}}").withMimeType(OutputFormatType.MARKDOWN);
    private final TemplateInput modelAggregateTemplate = new TemplateInput("io/zenwave360/sdk/plugins/EventCatalogEntitiesGenerator/ZdlToMarkdownAggregate.md", "{{targetFile}}").withMimeType(OutputFormatType.MARKDOWN);

    public EventCatalogEntitiesGenerator withOutputFormat(OutputFormat outputFormat) {
        this.outputFormat = outputFormat;
        return this;
    }

    public EventCatalogEntitiesGenerator withSkipDiagrams(boolean skipDiagrams) {
        this.skipDiagrams = skipDiagrams;
        return this;
    }

    public EventCatalogEntitiesGenerator withAggregateName(String aggregateName) {
