...
public class AvroAsyncApiProcessor extends AbstractBaseProcessor implements Processor {
    ...
    private String findSchemaFormat(Map<String, Object> apiModel, Map<String, Object> message) {
        ...
        var defaultSchemaFormat = SchemaFormatType.ASYNCAPI_YAML.getSchemaFormat((String) asyncapiVersion);
