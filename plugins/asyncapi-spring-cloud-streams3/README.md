...
| `functionalInterfaceImplementation` | Whether to use a 'java.util.function.Consumer' or 'java.util.function.Function' as the functional interface implementation.                                                             | FunctionalInterfaceImplementation | consumer             | consumer, function                |
